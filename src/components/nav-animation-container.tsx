	...
	return (
		<Container>
			<div className="flex items-center justify-between">
				<a href="/" className={cn("font-display text-3xl font-bold", invert ? "text-white" : "text-neutral-950")}>
					Codeart
				</a>
		...
		<MotionConfig transition={shouldReduceMotion ? { duration: 0 } : undefined}>
			<header>
				...
				<motion.div
					...
					className={cn(
						"bg-neutral-950",
						expanded ? "relative z-50 overflow-hidden pt-2" : "relative z-50 overflow-hidden pt-2",
					)}
			...
			<motion.div
				...
				className="relative flex flex-auto pt-14"
			>
